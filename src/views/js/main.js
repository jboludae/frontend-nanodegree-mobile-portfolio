...
var resizePizzas = function(size) {
  ...
  var newWidth // new variable where we will store new size of pizzas in %
  ...
  //   // All elements are the same size, so we can put the size calculations outside of the loop
...
// As backgroung pizzas are not changing, we move the selector outside of the loop
